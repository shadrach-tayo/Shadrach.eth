    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <section className="mb-12">
          <p className="text-center max-w-2xl mx-auto">Summarize me here</p>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              },
              {
                ...
                title: "Prettyfolio",
                description:
                  "A curated collection of portfolios for inspiration.",
              },
              {
                icon: "🎨",
                title: "Enchant",
          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-gray-600">
                  How my unexpected firing leads to career redemption and
                  valuable life lessons in the unpredictable world of tech.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            ...
            Receive valuable insights on the latest trends, techniques, and
            tools in web development and design.
          </p>
